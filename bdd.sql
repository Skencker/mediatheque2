...
--
-- Host: localhost    Database: mediatheque2
-- ------------------------------------------------------
...
CREATE TABLE `books` (
  ...
  PRIMARY KEY (`id`),
  KEY `IDX_4A1B2A9212469DE2` (`category_id`),
  KEY `IDX_4A1B2A924296D31F` (`genre_id`),
  CONSTRAINT `FK_4A1B2A9212469DE2` FOREIGN KEY (`category_id`) REFERENCES `categories` (`id`),
...
CREATE TABLE `borrow_details` (
  ...
  PRIMARY KEY (`id`),
  KEY `IDX_2CD60D0ED4C006C8` (`borrow_id`),
  CONSTRAINT `FK_2CD60D0ED4C006C8` FOREIGN KEY (`borrow_id`) REFERENCES `borrows` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `borrows` (
  ...
  `status` tinyint(1) NOT NULL,
  PRIMARY KEY (`id`),
  KEY `IDX_D03AA72FA76ED395` (`user_id`),
  CONSTRAINT `FK_D03AA72FA76ED395` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2021-10-15 14:32:30
